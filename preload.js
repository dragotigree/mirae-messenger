...
contextBridge.exposeInMainWorld('api', {
  ...
  sendFileViaSharedDrive: (opts) => ipcRenderer.invoke('send-file-via-shared-drive', opts),
  openSharedDriveFile: (filePath) => ipcRenderer.invoke('open-shared-drive-file', filePath),
  onSharedDriveUploadProgress: (callback) => {
  ...
  removeGroupMember: (uid, targetIp) => ipcRenderer.invoke('remove-group-member', { uid, targetIp }),
  deleteGroupChat: (uid) => ipcRenderer.invoke('delete-group-chat', { uid }),
  ...
  updateUnreadBadge: (payload) => ipcRenderer.invoke('update-unread-badge', payload),
  ...
  onTriggerFocusPeopleSearch: (callback) => ipcRenderer.on('trigger-focus-people-search', () => callback()),
  ...
  openRegionCaptureOverlay: () => ipcRenderer.invoke('open-region-capture-overlay'),
  onRegionCaptureResult: (callback) => ipcRenderer.on('region-capture-result', (e, dataUrl) => callback(dataUrl)),
  onCaptureOverlayInit: (callback) => ipcRenderer.on('capture-overlay-init', (e, dataUrl) => callback(dataUrl)),
  sendRegionCaptureConfirm: (dataUrl) => ipcRenderer.send('region-capture-confirm', dataUrl),
  sendRegionCaptureCancel: () => ipcRenderer.send('region-capture-cancel'),
