...
\$Ref = 'd842b5839e0ca5faca9427470b0c0b97a377010c'
$Expected = '1.0.497'
...
Write-Host "=== FORCE 1.0.497 (presence stale 45s) ===" -ForegroundColor Cyan
...
$wc.Headers['User-Agent'] = 'MiraeForce497'
...
$ok = $main.Contains('PRESENCE_STALE_MS = 45000') -and $main.Contains('allowUdpReceive')
Write-Host "version=$ver markers=$ok"
if ($ver -ne $Expected -or -not $ok) { throw "verify failed" }
Write-Host 'OK: 1.0.497 installed' -ForegroundColor Green
return
